...
;(function($) {
    ...
    $.smartPop = {
        ...
        resizeHeight : function(h) {
            ...
            // 높이설정
            $('#smartPop_container').height(parseInt(h)+parseInt(20)); /* 닫기버튼 보이게 margin-top 20px 추가 jdh798*/
            if(this.opts.url == '') {
    ...
    $.smartPop.defaults = {
        ...
        borderColor : '#000000',
        closeMargin : 3,
        closeImg    : {width:13, height:13, src:'/js/smartPop-master/img/btn_close1.png'},
        opacity     : .7,
        width       : 1000,
        height      : 700,
        html        : '',
